...
interface SmallMonthlyCalendarWidgetProps {}

/**
 * Add a small monthly calendar widget on the dashboard
 * Generated component based on natural language request
 */
export const SmallMonthlyCalendarWidget: React.FC<SmallMonthlyCalendarWidgetProps> = ({}) => {
    ...
    <div className="p-4 border-gray-200 bg-white border rounded-lg">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex items-center justify-between mb-4">
          <p className="text-gray-600">Add a small monthly calendar widget on the dashboard</p>
...
export default SmallMonthlyCalendarWidget;
