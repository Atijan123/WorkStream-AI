...
class FastComponentGenerator {
    ...
    generateFastComponentContent(request) {
        const componentName = this.toPascalCase(request.name);
...
export default ${componentName};`;
    ...
    generateSimpleComponent(request) {
    ...
    generateCounterWidget(request, styling) {
  ...
  private generateCalendarComponent(request: ParsedFeatureRequest, styling: string): string {
    return `;
        ...
        return className = {} `${styling} \${className}\`}>
    ...
    generateSimpleChart(request, styling) {
  ...
  return (
    ...
    generateSimpleTable(request, styling) {
        return `  const [data] = React.useState([
  ...
  return (
    ...
    generateSimpleForm(request, styling) {
  ...
  return (
    ...
    generateSimpleButton(request, styling) {
  ...
  return (
    ...
    generateWeatherWidget(request, styling) {
  ...
  return (
    ...
    generateNotesWidget(request, styling) {
  ...
  return (
    ...
    generateGenericWidget(request, styling) {
        return `  const [count, setCount] = React.useState(0);
...
exports.FastComponentGenerator = FastComponentGenerator;
//# sourceMappingURL=FastComponentGenerator.js.map